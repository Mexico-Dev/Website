...
import NicoleDev from "./nicole-dev.jpg";
		...
		<>
			...
			<div className="container">
				<div className="row">
					...
					<div className="col-12 mb-5 text-center">
						<a href="https://discord.gg/mexicodev" class="btn btn-outline-secondary btn-lg" target="_blank">
							Unirme ahora <i class="bi bi-box-arrow-up-right"/>
						</a>
					</div>
					<div className="col-12 mb-5 text-center">
						<img
